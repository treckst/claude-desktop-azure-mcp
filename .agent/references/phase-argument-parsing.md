...
```bash
PHASE_INFO=$(node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs find-phase "${PHASE}" --raw)
```
