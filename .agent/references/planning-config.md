...
node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: update state" --files .planning/STATE.md

# Load config via state load (returns JSON):
INIT=$(node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs state load)
# commit_docs is available in the JSON output

# Or use init commands which include commit_docs:
INIT=$(node /Users/arshad/.claude/get-shit-done/bin/gsd-tools.cjs init execute-phase "1")
